...
function processRequest(request, response) {
    ...
    fs.stat(filePath, (err, stats) => {
        if (err) {
            ...
            response.writeHead(404,{"Cache-Control":"public,max-age=1000000"});
            ...
            fs.readdir(filePath, (err, files) => {
                if (err) {
                    ...
                    if (!flag) {
                        ...
                        response.writeHead(200,{"Cache-Control":"public,max-age=1000000"});
                        response.end(html);
                    }
                }
            });
        ...
        function readFile(filePath, contentType) {
            ...
            stream.on('error', function() {
                ...
                response.writeHead(500,{"Cache-Control":"public,max-age=1000000"});
